...
type NoticesModel struct {
	...
	TargetType    uint           `json:"targetType" gorm:"default:0;comment:目标类型"`
	TargetIds     []int64        `json:"targetIds" gorm:"column:target_ids;type:text;serializer:json;comment:目标用户ID"` // 改为int64数组
